...
const TripDetailCard = () => {
  return (
    <View style={styles.cardContainerStyle}>
      ...
      <View style={styles.rowStyle}>
        <Text style={styles.dateTextStyle}>開始: 2022年 7月30日</Text>
      </View>
      <View style={styles.rowStyle}>
        <Text style={styles.dateTextStyle}>結束: 2022年 8月1日</Text>
      </View>
      <View>
        <Chip icon="map-marker-outline" style={{backgroundColor: '#fff'}}>台中</Chip>
      </View>
